...
class Exp(MyExp):
    def __init__(self):
        ...
        self.max_epoch = 40  # Reduced from 80 for faster training
        self.no_aug_epochs = 5  # Reduced from 10
        self.warmup_epochs = 2  # Reduced from 3
        self.eval_interval = 10  # Evaluate every 10 epochs instead of 5
        self.min_lr_ratio = 0.05
        self.basic_lr_per_img = 0.01 / 64.0
        
        # Input sizes for VisDrone (native: 1344x756, aspect ratio 16:9)
        # Reduced resolution for faster training
        self.input_size = (512, 896)  # ~50% fewer pixels than (640, 1152)
        self.test_size = (512, 896)   # Still maintains aspect ratio
